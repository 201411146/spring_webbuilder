...
<c:forEach items="${dtos}" var="dtos">
 ${dtos.location} <a href="/${sitename}/view?boardid=${dtos.getBoardid()}"> ${dtos.getTitle()} </a> ${dtos.money} ${dtos.regdate}
<a href="/${sitename}/deletebookmark?boardid=${dtos.getBoardid()}"> 삭제 </a>
</c:forEach>
</body>
</html>